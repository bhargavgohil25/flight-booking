...
class BookingControllerIntegrationTest {
    ...
    void bookFlight_validRequest_returns201() throws Exception {
        BookingRequest request = new BookingRequest("SG101", "Jane Doe", "jane@example.com", 2);
    ...
    void bookFlight_unknownFlight_returns404() throws Exception {
        BookingRequest request = new BookingRequest("XX999", "Jane Doe", "jane@example.com", 1);
    ...
    void bookFlight_insufficientSeats_returns409() throws Exception {
        BookingRequest request = new BookingRequest("UK833", "Jane Doe", "seats@example.com", 100);
    ...
    void bookFlight_duplicate_returns409() throws Exception {
        BookingRequest request = new BookingRequest("EK502", "Dup Test", "dup@example.com", 1);
